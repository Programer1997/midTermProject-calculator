...
var result =0;
	...
	resultadoDiv.innerHTML = "<p>Tu BMR es: <strong>" + result.toFixed(2) + " calorías</strong><br> It means that you need consume that number if you want keep your weight</p>";
